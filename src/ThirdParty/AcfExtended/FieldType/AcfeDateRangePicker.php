		...
		register_graphql_object_type( 'ACFE_Date_Range', [
			...
			'fields' => [
				'startDate' => [
					...
					'type' => 'String',
					'description' => __( 'The start date of a date range returned as an RFC 3339 time string', 'wp-graphql' ),
				],
				'endDate' => [
					// @todo: DATETIME Scalar
					'type' => 'String',
					'description' => __( 'The start date of a date range RFC 3339 time string', 'wp-graphql' ),
				],
			],
		]);
